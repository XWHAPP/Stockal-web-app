...
export const nasdaq: Array<StockSearchOptions> = [
  {
    symbol: 'A',
  ...
  {
    symbol: 'ACY',
    name: 'AeroCentury Corp. Common Stock',
  },
  {
    symbol: 'ADAG',
  ...
  {
    symbol: 'EXCVV',
    name: 'Exelon Corporation Common Stock Ex-Distribution When-Issued',
  },
  {
    symbol: 'EXD',
  ...
  {
    symbol: 'FTSI',
    name: 'FTS International Inc. Class A Common Stock',
  },
  {
    symbol: 'FTV',
  ...
  {
    symbol: 'HORIW',
    name: 'Emerging Markets Horizon Corp. Warrants',
  },
  {
    symbol: 'HOTH',
